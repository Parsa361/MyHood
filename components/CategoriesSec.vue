<template>
  <div>
    ...
    <div class=" my-[1rem] mt-[4rem] mx-auto flex flex-row items-center justify-center font-Lalezar gap-5">
      ...
      <span class="font-Lalezar text-[0.75rem] md:text-[1rem] lg:text-[1.5rem]">دسته بندی محصولات</span>
      <svg xmlns="http://www.w3.org/2000/svg" width="111" height="3" class="flex w-[5rem] md:w-[7rem]"
        viewBox="0 0 111 3">
        <line id="Line_2" data-name="Line 2" x2="108" transform="translate(1.5 1.5)" fill="none" stroke="#fcb900"
          stroke-linecap="round" stroke-width="3" />
    ...
    <div class="bg-white">
      <!-- Container -->
      <div class="container mx-auto my-[2.5rem]">
        <!-- Content -->
        <div class="flex flex-col md:flex-row mb-[0.5rem]">
          <!-- Image 1-->
          <div class="md:w-1/2">
            <img src="~/assets/images/hidden.png" alt="hidden hood" class="object-cover object-center" />
          </div>
          <!-- Text 1-->
          <div class="flex flex-col md:w-1/2 px-2 py-2">
            <p class="text-center md:text-start font-Lalezar text-[0.75rem] xl:mb-[1rem] md:text-[1.5rem]"> هود مخفی</p>
            <p
              class="hidden lg:flex text-center md:text-start font-VazirLight text-[0.75rem] md:text-[1rem] xl:mb-[1rem]">
